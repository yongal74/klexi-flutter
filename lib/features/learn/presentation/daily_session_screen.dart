          ...
          Expanded(
            child: ListView.separated(
              ...
              itemBuilder: (context, i) => _WordTile(
                word: _words[i],
                onTap: () => context
                    .push('${AppRoutes.sentenceCard}?wordId=${_words[i].id}'),
              ),
            ),
          ),
          SafeArea(
      ...
      child: ClipRRect(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              color: levelBg,
              padding: const EdgeInsets.fromLTRB(AppSpacing.cardPad,
                  AppSpacing.md, AppSpacing.cardPad, AppSpacing.md),
              child: Row(
                children: [
                  Container(
                    padding:
                  ...
                  Icon(Icons.chevron_right,
                      color: levelColor.withOpacity(0.6), size: 18),
                ],
              ),
            ),
            // ── 흰색 하단 영역 (영어) ──
            Container(
              color: Colors.white,
              padding: const EdgeInsets.fromLTRB(AppSpacing.cardPad,
                  AppSpacing.sm, AppSpacing.cardPad, AppSpacing.sm),
