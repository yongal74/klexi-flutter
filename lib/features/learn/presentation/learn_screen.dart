...
class _LearnScreenState extends ConsumerState<LearnScreen> {
  ...
  Widget build(BuildContext context) {
    // Watch live provider so progress updates without navigating away
    final liveCount = ref.watch(todayStudiedCountProvider);
    final todayDone = liveCount > 0 ? liveCount : _todayDone;
    return Scaffold(
        ...
        child: Column(
          ...
          children: [
            ...
            _PracticeCard(
              ...
              subtitle: 'Reinforce with grouped sentence review',
              color: AppColors.topik3,
              onTap: () => context.push(AppRoutes.sentencePractice),
            ),
            const SizedBox(height: AppSpacing.listGap),
            _PracticeCard(
              icon: '🧠',
              title: 'Quiz',
              subtitle: 'Multiple choice vocabulary quiz',
            ...
            _PracticeCard(
              icon: '🔄',
              title: 'Review',
              subtitle: 'Revisit wrong answers and hard words',
              color: AppColors.topik4,
